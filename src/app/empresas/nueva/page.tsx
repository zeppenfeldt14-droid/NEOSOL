import { createEmpresa } from '@/app/zonas/[zonaName]/empresas/nueva/actions'
...
export default async function NuevaEmpresaGlobalPage() {
  const user = await getSessionUser()
  if (!user) {
    redirect('/login')
  }

  const decodedZona = 'SIN ASIGNAR';
  const zonaName = 'CABA'; // fallback
